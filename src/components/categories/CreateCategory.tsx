  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="flex items-center gap-2 px-2 py-2 mt-2 text-sm font-medium text-slate-500 hover:text-slate-700 hover:bg-slate-100/50 rounded-lg transition-colors w-full"
      >
        <Plus size={16} />
        Add Category
      </button>
