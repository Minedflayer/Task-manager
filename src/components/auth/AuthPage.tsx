        ...
        <div className="bg-white/60 backdrop-blur-2xl border border-white/40 rounded-3xl shadow-xl p-8">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full pl-10 pr-4 py-2.5 bg-white/70 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-300 focus:border-indigo-300 transition-all"
                />
              </div>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 py-2.5 bg-slate-900 text-white font-medium text-sm rounded-xl hover:bg-slate-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {mode === "signin" ? (
                <>
                  <LogIn size={16} />
          ...
          <button
            type="button"
            onClick={onGuest}
            className="w-full py-2.5 border-2 border-dashed border-slate-300 text-slate-600 font-medium text-sm rounded-xl hover:border-slate-400 hover:bg-slate-50 transition-all"
          >
            Try as Guest
          </button>
        </div>
